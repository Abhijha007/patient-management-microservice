...
public class PatientRequestDTO {
    ...
    public @NotBlank @Size(max = 100, message = "Name cannot exceed 100 character") String getName() {
        return name;
    }

    public void setName(@NotBlank @Size(max = 100, message = "Name cannot exceed 100 character") String name) {
        this.name = name;
    }
